...
#define SUBSCRIPTION_RING_BUFFER_SIZE 10
...
struct conn_slot {
	...
	struct bt_gatt_subscribe_params *subscribe_params[MAX_SUBSCRIPTIONS_PER_CONN];
...
/* Global ring buffer for subscription parameters */
extern struct bt_gatt_subscribe_params subscribe_ring_buffer[SUBSCRIPTION_RING_BUFFER_SIZE];
extern int next_subscribe_slot;
